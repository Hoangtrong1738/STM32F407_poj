All:
	...
	arm-none-eabi-gcc build/test_timer.o build/clock.o build/gpio.o build/i2c.o build/spi.o build/delay.o build/uart.o build\control.o build/motor.o build\encoder.o build\pid.o build/startup.o -mcpu=cortex-m4 -mthumb -T"STM32F407VETX_FLASH.ld" -Wl,-Map="file.map" -Wl,--gc-sections -static --specs=nosys.specs -o build/blink_led.elf
